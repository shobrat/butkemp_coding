...
// int n = int.Parse(Console.ReadLine()!), result = 0; //вослицательный знак убирает предупреждения о том что могут быть значения допускающих Null
// // int n = Convert.ToInt32(Console.ReadLine()); можно использовать и эту функцию но она работает медленнее чем "Parce"
// for (int i = 0; i <= n; i++)
// {
//     result += i;
// }
...
// Console.Clear();
// Console.Write("Введите число: ");
// double n = int.Parse(Console.ReadLine()!); // здесь мы поменяли тип значения int на double, чтобы ответ был правильным до десятых или соты
